  ...
  useEffect(() => {
    ...
    const handleMessage = (message) => {
      ...
      if (message?.conversation) {
        // Ganti conversation dengan data terbaru untuk hindari duplikasi
        setConversation(message.conversation)
      }
    }
...
- "Itu saja untuk hari ini. Terima kasih atas waktunya."
  ...
  const GenerateFeedback = async () => {
    ...
    try {
      ...
      console.log('Raw content from API:', result.data.content)

      const Content = result.data.content || '' // Default ke string kosong jika undefined
